...
export default function FileViewerPage() {
      ...
      try {
        ...
        if (isLatexFile) {
          ...
          if (documentData && !documentError) {
            ...
            const { data: documentData2, error: documentError2 } =
              await supabase
                .from('documents')
                .select('*')
            ...
            if (documentData2 && !documentError2) {
              ...
              setFileContent(DEFAULT_LATEX_CONTENT(documentTitle));
            }
          }
        } else {
  ...
  if (!file || !project) {
    return (
      <main className="container mx-auto px-4 py-8">
        <div className="text-center">
          <p className="mb-4 text-neutral-600">File not found</p>
          <Link href="/projects">
            <Button variant="outline">
              <ArrowLeft className="mr-2 h-4 w-4" />
              Back to Projects
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-neutral-500">File in {project.title}</p>
          </div>
